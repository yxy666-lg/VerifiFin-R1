...
![VerifiFin-R1全流程：金融数据、过程监督、可验证Reward、GRPO与推理重排](docs/assets/verififin-r1-pipeline.svg)
...
- 统一评测记录：FinEval-val（1,151题）SFT为73.15%，GRPO为73.76%，完整跑通SFT—PRM—GRPO训练闭环。
- 实现Rule/PRM混合Reward、GRPO训练、Best-of-N重排及配对统计检验流程。
