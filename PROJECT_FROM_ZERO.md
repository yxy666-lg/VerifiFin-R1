...
新版PRM尚未重新训练，因此这些是已实现的实验协议，不是已有提升结果。
...
当前已经完成的是旧Reward下的GRPO实验。新版Hybrid Reward没有重新训练，因此不能把旧结果归因于新版方法。
...
逐题比较适合paired bootstrap置信区间和McNemar检验。多随机种子则报告mean±std。当前未完成多种子复跑，因此不宣称统计显著。
